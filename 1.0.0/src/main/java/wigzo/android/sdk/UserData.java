...
public class UserData {
    ...
    static void setData(Map<String, String> data){
        ...
        if(picturePath != null){
            ...
            if (!sourceFile.isFile()) {
                if (Wigzo.sharedInstance().isLoggingEnabled()) {
                    Log.w(Wigzo.TAG, "Provided file " + picturePath + " can not be opened");
                }
                picturePath = null;
            }
        }
        ...
        if(data.containsKey(BYEAR_KEY)){
            try {
                ...
                if (Wigzo.sharedInstance().isLoggingEnabled()) {
                    Log.w(Wigzo.TAG, "Incorrect byear number format");
                }
                byear = 0;
            }
        }
    ...
    static JSONObject toJSON() {
        ...
        try {
            ...
            if (Wigzo.sharedInstance().isLoggingEnabled()) {
                Log.w(Wigzo.TAG, "Got exception converting an UserData to JSON", e);
            }
        }
        ...
        if(json != null){
            ...
            if (!json.isNull(CUSTOM_KEY)) {
                ...
                try {
                    ...
                    if (Wigzo.sharedInstance().isLoggingEnabled()) {
                        Log.w(Wigzo.TAG, "Got exception converting an Custom Json to Custom User data", e);
                    }
                }
            }
        }
